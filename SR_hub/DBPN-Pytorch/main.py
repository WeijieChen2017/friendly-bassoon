...
parser.add_argument('--hr_train_dataset', type=str, default='z71')
...
parser.add_argument('--pretrained_sr', default='z71L1122-WCHENDBPN-RES-MR64-3Z71_INV_epoch_199.pth', help='sr pretrained base model')
...
parser.add_argument('--prefix', default='Z71_INV', help='Location to save checkpoint models')
