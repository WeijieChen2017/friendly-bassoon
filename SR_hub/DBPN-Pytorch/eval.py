...
parser.add_argument('--model', default='weights/z71L1122-WCHENDBPN-RES-MR64-3Z71_CONSTANT_DC_PoissonNLLLoss_epoch_999.pth', help='sr pretrained base model')
...
def eval():
    ...
    for pet_path in pet_list:
        print("&"*60)
        print(pet_path)
        bicubic_nii = nib.load(pet_path[:-11]+"_250.nii.gz") # 1200
        input_nii = nib.load(pet_path[:-11]+"_100.nii.gz") # 300
