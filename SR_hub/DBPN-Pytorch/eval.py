...
parser.add_argument('--test_dataset', type=str, default='z71')
parser.add_argument('--model_type', type=str, default='DBPN-RES-MR64-3')
parser.add_argument('--residual', type=bool, default=False)
parser.add_argument('--model', default='weights/z71L1122-WCHENDBPN-RES-MR64-3Z71_INV_epoch_899.pth', help='sr pretrained base model')
...
def eval():
    ...
    pet_list = glob.glob(os.path.join(opt.input_dir,opt.test_dataset)+"/*_250.nii.gz")
    ...
    for pet_path in pet_list:
        print("&"*60)
        print(pet_path)
        bicubic_nii = nib.load(pet_path[:-11]+"_x240y240z71f3.nii.gz") # 1200
        input_nii = nib.load(pet_path[:-11]+"_x960y960z71.nii.gz") # 300
