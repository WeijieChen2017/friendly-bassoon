...
parser.add_argument('--input_dir', type=str, default='eval_dataset')
parser.add_argument('--output', default='results/', help='Location to save checkpoint models')
parser.add_argument('--test_dataset', type=str, default='s1_eval')
parser.add_argument('--model_type', type=str, default='DBPN-RES-MR64-3')
parser.add_argument('--residual', type=bool, default=False)
parser.add_argument('--model', default='weights/score_1L1122-WCHENDBPN-RES-MR64-3NAC2CT_epoch_', help='sr pretrained base model')
